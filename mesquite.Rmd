...
The corresponding rstanarm model fir
```{r}
...
If look more carefully on of the subplots, we see that although marginal posterior intervals overlap 0, some pairwise joint posteriors are not overlapping 0. Let's look more caerfully the joint posterior of log(CanVol) and log(CanAre).
```{r}
