...
We can also examine calibrations using posterior or LOO predictive probabilities.
...
From the calibration plot we see that the model is otherwise calibrated except that there is an excess of events for cases that have very low predicted probability. 
...
Non-linear model appears to be better calibrated, although the difference is small.
