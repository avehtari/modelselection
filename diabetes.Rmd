...
# confusion matrix
caret::confusionMatrix(as.factor(pr), y)[2:3]
...
ploo=E_loo(preds, type="mean", loo1$psis_object, log_ratios = -log_lik(post1))$value
# LOO classification accuracy
round(mean(xor(ploo>0.5,as.integer(y==0))),3)
...
```{r}
(nv <- suggest_size(varsel2,alpha=0.1))
```
