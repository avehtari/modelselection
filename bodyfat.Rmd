...
Vehtari [-@Piironen+etal:projpred:2020] and implemented in R package
...
This notebook was initially created in 2018, but has later been extended to an article "Using reference models in variable selection" by Pavone, Piironen, Bürkner and Vehtari [-@Pavone+etal:2020].
...
and Vehtari [-@Piironen+etal:projpred:2020] present further
