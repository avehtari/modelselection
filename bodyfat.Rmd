...
Load libraries. This notebook is using a new `suggest_size` function __projpred__ package, which is currently available at [github](https://github.com/stan-dev/projpred).
```{r}
library(here)
library(rstanarm)
